# Contributing to glassloop

Thanks for your interest in contributing! This repository is the **open**
(glassloop) part of the project — it runs with no license. The advanced GMS
...
```bash
git clone https://github.com/knowlytix/beyond-prompt-and-pray.git
cd beyond-prompt-and-pray
python3.12 -m venv .venv && source .venv/bin/activate
pip install torch --index-url https://download.pytorch.org/whl/cpu  # CPU torch for model tests
pip install -e ".[dev]"
pytest -q
```
