...
from glassloop.models.tinygpt.positional import (
    LearnedPositionalEmbedding,
    SinusoidalPositionalEmbedding,
)
from glassloop.models.tinygpt.transformer_block import TransformerBlock
from glassloop.models.tinygpt.losses import cross_entropy_loss
...
class TinyGPT(nn.Module):
    ...
    def forward_cached(
        ...
        is a ``KVCache`` from ``glassloop.models.tinygpt.kv_cache`` or
        ...
        """
        from glassloop.models.tinygpt.kv_cache import KVCache
